...
start "AI Vision Frontend" "%CMD_EXE%" /k "cd /d ""%ROOT_DIR%\frontend"" && npm run dev"

:: 2. Start Backend FastAPI Server
echo Starting Backend FastAPI Server...
start "AI Vision Backend App" "%CMD_EXE%" /k "cd /d ""%ROOT_DIR%\backend"" && uvicorn app.main:app --reload --host 0.0.0.0 --port 8000"
